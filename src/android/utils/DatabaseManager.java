...
public class DatabaseManager {
  ...
  public String saveBlob(DocumentArgument docArgs) {
  ...
  public String saveBlobFromEmbeddedResource(DocumentArgument docArgs, Context context) {
  ...
  public String saveBlobFromFileURL(DocumentArgument docArgs, Context context) {
