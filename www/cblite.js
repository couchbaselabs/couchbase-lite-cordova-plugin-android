 ...
 *  		is false.
 * @param language 
 *          {string} The language code which is an ISO-639 language code such as “en”,
 *  		“fr”, etc. Setting the language code affects how word breaks and word 
 * 			stems are parsed. Without setting the language code, the current locale’s
 *  		language will be used. Setting “” value to disable the language features.
 * @param indexes 
 *          {[string]} array of strings with what indexes to add 
 * @param successCallback 
 *          {callback} javascript function to call if native code is successful 
